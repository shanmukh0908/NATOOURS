 ...
 */
      ...
      function (require, module, exports) {
        ...
        var _default = (config) => {
          ...
          newConfig.url = (0, _buildURL.default)(
            (0, _buildFullPath.default)(newConfig.baseURL, newConfig.url),
            config.params,
        ...
        isFetchSupported &&
          ((res) => {
            ['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach(
              (type) => {
                !resolvers[type] &&
                  (resolvers[type] = _utils.default.isFunction(res[type])
                    ? (res) => res[type]()
                    : (_, config) => {
                        throw new _AxiosError.default(
    ...
    'login.js': [
        ...
        var login = (exports.login = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(
              function _callee(email, password) {
                var res;
      ...
      { './alerts': 'alerts.js', axios: '../../node_modules/axios/index.js' },
    ],
    'updatedata.js': [
      function (require, module, exports) {
        'use strict';
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      ...
                      case 4:
                        res = _context.sent;
                        if (res.data.status === 'success') {
                          (0, _alerts.showalert)('success', 'update success');
                        }
                        _context.next = 12;
                        break;
                      case 8:
        ...
        var updatepassword = (exports.updatepassword =
          /*#__PURE__*/ (function () {
            var _ref2 = _asyncToGenerator(
    ...
    'stripe.js': [
      function (require, module, exports) {
        ...
        var booktour = (exports.booktour = /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(tourid) {
              var session;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1)
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var passowrdform = document.querySelector('.form-user-password');
        var savepasswordbutton = document.querySelector('.btn--save-password');
        ...
        if (updateform) {
          updateform.addEventListener('submit', function (e) {
            ...
            (0, _updatedata.updatedata)(form);
          });
        }
        if (passowrdform) {
          passowrdform.addEventListener(
            'submit',
            /*#__PURE__*/ (function () {
              var _ref = _asyncToGenerator(
                    ...
                    while (1)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          _context.next = 7;
                          return (0, _updatedata.updatepassword)({
